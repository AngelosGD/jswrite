...
export default function NewNotebookModal() {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div className="w-96 rounded border border-gray-200 bg-white p-6 shadow-lg">
        ...
        <div className="mt-6 flex justify-end gap-2">
          <button className="border border-gray-400 p-2 transition duration-280 ease hover:bg-black hover:text-white active:scale-95">
            Cancelar
          </button>
